...
const HomePage = ({ onSignUp }) => {
    ...
    const faqItems = [
        ...
        { q: "Mes données financières sont-elles en sécurité ?", a: "La sécurité de vos données est notre priorité absolue. Nous utilisons une infrastructure sécurisée (apiService) avec un chiffrement de niveau bancaire et des politiques de sécurité strictes qui garantissent que vous seul avez accès à vos informations." },
